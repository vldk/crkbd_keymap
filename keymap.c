...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_split_3x6_3(
        ...
        KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B,                             KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                                KC_RALT, MO(_LOWER), KC_SPC,            KC_ENT, MO(_RAISE), MO(_ADJUST)
    ),
	[_LOWER] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_BRID, KC_BRIU, KC_VOLD, TD(TD_MEDIA), KC_VOLU,               KC_LBRC, KC_RBRC, KC_EQL, KC_MINS, KC_BSLS, KC_TILD,
                                        KC_TRNS, KC_TRNS, KC_LCTL,  KC_TRNS, KC_TRNS, KC_RGUI
    ),
	[_RAISE] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS, KC_F11, KC_F12, KC_NO, KC_NO, KC_CAPS,                     KC_DEL, KC_NO, KC_PPLS, KC_PMNS, KC_SLSH, KC_END,
                                        KC_TRNS, KC_TRNS, KC_LCTL,  KC_TRNS, KC_TRNS, KC_APP
    ),
